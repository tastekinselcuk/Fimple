    ...
    public class FightService : IFightService
    {
        ...
        public async Task<ServiceResponse<FightResultDto>> Fight(FightRequestDto request)
        {
            ...
            try 
            {
                ...
                bool defeated = false;
                while(!defeated) //will stop if the first character defeated
                {
                    foreach(var attacker in characters)
                    {
                        ...
                        bool useWeapon = new Random().Next(2) == 0; //0-1 arası sayı döner ve 0'a eşitliğine göre bool belirlenir.
        ...
        public async Task<ServiceResponse<AttackResultDto>> SkillAttack(SkillAttackDto request)
        {
            ...
            try
            {
                ...
                var skill = attacker.Skills.FirstOrDefault(a => a.Id == request.SkillId);
                if (skill is null)
                {
                    response.Success = false;
